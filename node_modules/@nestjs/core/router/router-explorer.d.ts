...
export declare class RouterExplorer {
    ...
    explore<T extends HttpServer = any>(instanceWrapper: InstanceWrapper, module: string, applicationRef: T, basePath: string): void;
    ...
    applyPathsToRouterProxy<T extends HttpServer>(router: T, routePaths: RoutePathProperties[], instanceWrapper: InstanceWrapper, module: string, basePath: string): void;
    private applyCallbackToRouter;
    private createCallbackProxy;
    createRequestScopedHandler(instanceWrapper: InstanceWrapper, requestMethod: RequestMethod, module: Module, moduleKey: string, methodName: string): <TRequest, TResponse>(req: TRequest, res: TResponse, next: () => void) => Promise<void>;
