...
const getSyntaxKindName_1 = require("../utils/compiler/getSyntaxKindName");
...
exports.throwIfWhitespaceOrNotString = throwIfWhitespaceOrNotString;
/**
...
function throwNotImplementedForSyntaxKindError(kind) {
    throw new classes_1.NotImplementedError(`Not implemented feature for syntax kind '${getSyntaxKindName_1.getSyntaxKindName(kind)}'.`);
}
exports.throwNotImplementedForSyntaxKindError = throwNotImplementedForSyntaxKindError;
/**
 * Throws an Argument
 * @param value
 * @param argName
...
function throwNotImplementedForNeverValueError(value) {
    ...
    throw new classes_1.NotImplementedError(`Not implemented value: ${JSON.stringify(value)}`);
}
exports.throwNotImplementedForNeverValueError = throwNotImplementedForNeverValueError;
/**
