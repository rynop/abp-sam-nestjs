...
class GetAccessorDeclarationStructurePrinter extends NodePrinter_1.NodePrinter {
    constructor(factory, options) {
        super(factory);
        this.options = options;
        this.blankLineWriter = new formatting_1.BlankLineFormattingStructuresPrinter(this);
    }
