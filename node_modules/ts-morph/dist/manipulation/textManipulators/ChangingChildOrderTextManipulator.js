...
class ChangingChildOrderTextManipulator {
    ...
    getNewText(inputText) {
        ...
        const movingNodeStart = textSeek_1.getPosAtNextNonBlankLine(fullText, movingNode.getPos());
        ...
        const isParentSourceFile = utils_1.TypeGuards.isSourceFile(parent.getParentOrThrow());
        let finalText = "";
        fillPrefixText();
        ...
        function fillSpacingCommon(spacingOpts) {
            const spacing = getSpacingBetweenNodes_1.getSpacingBetweenNodes({
                parent,
